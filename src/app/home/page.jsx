...
export default function JobBoardPage() {
  ...
  const featuredJobs = [
    ...
    },
    {
      ...
      url: "/home/social-media-marketing"
    },
    {
      id: 103,
  ...
  const handleFeaturedJobClick = (url) => {
    router.push(url);
  };
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-80">
          ...
          <div className="bg-white rounded-lg shadow-sm overflow-hidden mb-6">
            <div 
              className="relative h-64 md:h-80 lg:h-[525px] w-full cursor-pointer"
              onMouseEnter={() => setIsHoveringFeatured(true)}
              onMouseLeave={() => setIsHoveringFeatured(false)}
              onClick={() => handleFeaturedJobClick(featuredJobs[currentFeatured].url)}
            >
              <Image
